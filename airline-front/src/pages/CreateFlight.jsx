...
const CreateFlight = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.departure_city.trim()) {
      newErrors.departure_city = 'La ciudad de salida es requerida';
    }
    if (!formData.arrival_city.trim()) {
      newErrors.arrival_city = 'La ciudad de llegada es requerida';
    }
    ...
    if (!formData.available_seats || parseInt(formData.available_seats) <= 0) {
      newErrors.available_seats = 'Los asientos disponibles deben ser mayor a 0';
    }
    if (!formData.aircraft_type.trim()) {
      newErrors.aircraft_type = 'El tipo de aeronave es requerido';
    }
          ...
          <div className="form-grid">
            <div className="form-group">
              ...
              {errors.departure_city && (
                <span className="error-text">{errors.departure_city}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              />
              {errors.arrival_city && (
                <span className="error-text">{errors.arrival_city}</span>
              )}
            </div>
            ...
            <div className="form-group">
              ...
              {errors.departure_time && (
                <span className="error-text">{errors.departure_time}</span>
              )}
            </div>
